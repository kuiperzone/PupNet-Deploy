...
/// </summary>
public class PackageBuilderOld
{
    ...
    /// Constructor.
    /// </summary>
    public PackageBuilderOld(ArgumentReader args)
    ...
    /// Constructor.
    /// </summary>
    public PackageBuilderOld(ConfigurationReader conf)
    {
        Conf = conf;
        Args = conf.Arguments;
        Tree = new(conf);
    ...
    /// Gets configuration.
    /// </summary>
    public ArgumentReader Args { get; }
    ...
    public void Run()
    {
        ...
        if (Conf.Arguments.IsSkipYes || new ConfirmPrompt().Wait())
        {
            Console.WriteLine();
            ...
            {
                // Used by AppImage
                Environment.SetEnvironmentVariable("ARCH", Conf.Arguments.Arch);
            }
